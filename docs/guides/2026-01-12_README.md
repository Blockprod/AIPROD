# AIPROD - Pipeline de Génération Vidéo IA

## 🎯 Description

AIPROD est une plateforme cloud-native de génération vidéo IA avec :
...
Les logs sont stockés dans `logs/AIPROD.log` avec rotation automatique :
...
2. Vérifiez les logs dans `logs/AIPROD.log`
3. Lancez les tests pour diagnostiquer les problèmes

## 📄 Licence

Propriétaire - AIPROD (2026)
