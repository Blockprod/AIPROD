...
uv run accelerate launch --num_processes 2 scripts/train.py configs/AIPROD2_av_lora.yaml

# Select specific GPUs
CUDA_VISIBLE_DEVICES=0,1 uv run accelerate launch scripts/train.py configs/AIPROD2_av_lora.yaml
```
...
- **Run inference with your trained LoRA** - The [`AIPROD-pipelines`](../../AIPROD-pipelines/) package provides
  production-ready inference
  pipelines that support loading custom LoRAs. Available pipelines include text-to-video, image-to-video,
  IC-LoRA video-to-video, and more. See the [`AIPROD-pipelines`](../../AIPROD-pipelines/) package for usage details.
...
Join our [Discord community](https://discord.gg/AIPRODplatform) for real-time help!
