...
> [!TIP]
> For production inference, consider using the [`AIPROD-pipelines`](../../AIPROD-pipelines/) package which provides optimized,
...
uv run accelerate launch --num_processes 4 scripts/train.py configs/AIPROD2_av_lora.yaml
```
